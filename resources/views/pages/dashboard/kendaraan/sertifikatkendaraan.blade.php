...
<!-- Begin Page Content -->
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark font-weight-bold text-capitalize">legalitas kendaraan</h1>
        </div>
        ...
        <button type="button" class="btn btn-outline-info btn-lg mb-4" onclick="event.preventDefault(); location.href='{{ url('tambahlegalitas') }}'">+ Tambah legalitas</button>
